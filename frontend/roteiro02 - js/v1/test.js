...
describe('factory Turma', function() {
    ...
    it('deve ter método para matricular estudantes', function() {
        ...
        e0 = estudante('111111111', 'Arthur', 'arthur@email.com', '11122233344', 'foto.com')
        ...
        e1 = estudante('222222222', 'João', 'joao@email.com', '22233344455', 'foto1.com')
...
describe('factory Professor', function() {
    ...
    before(async () => {
        p0 = professor('333333333', 'Professor', 'prof@email.com', '44455566677', 'foto.com')
    })
    ...
    it('deve ter um método turmas(semestre)', function() {
        ...
        d1 = disciplina('psoft', 'Projeto de Software', 4, [d0])
        t1 = turma(d1, 4)
        p0.aloca_turma(t1)
